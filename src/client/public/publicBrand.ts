...
export const APPLICATION_RIGHTS_NOTE = 'Application rights go to Sarva Horizon.';
...
export const buildWhatsappContactUrl = (message?: string): string =>
  `https://wa.me/${WHATSAPP_PHONE_E164}?text=${encodeURIComponent(
    message || 'Hello Sarva Horizon, I would like to know more about the Sarva sports complex management platform.'
  )}`;
