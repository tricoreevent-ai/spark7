const ROUTE_USAGE: Record<string, string> = {
  ...
  '/attendance': 'Open Attendance Register page to enter or review manual attendance',
  '/attendance/self': 'Open Employee Attendance page to check in or check out using current time and GPS',
